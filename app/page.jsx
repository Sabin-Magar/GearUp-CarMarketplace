...
export default async function Home() {
  ...
  return (
    <div >
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-5xl md:text-8xl mb-4 gradient-title">
              Find your Dream Car with GearUp
            </h1>
      ...
      <section className="relative py-16 md:py-40 md:pb-16 dotted bg-cover bg-center bg-no-repeat bg-black/20 bg-blend-multiply"
